...
function LoadCategoryStatistic() {
    $.ajax({
        ...
        cache: !0,
        success: function (n) {
            n != null && n != "" && ($(".moreproduct a span").eq(0).html(n.phone), $(".moreproduct a span").eq(1).html(n.tablet), $(".moreproduct a span").eq(2).html(n.laptop), $(".moreproduct a span").eq(3).html(n.accessory), $(".moreproduct a span").eq(4).html(n.oldproduct))
        }
    })
}

function formatNumberValue(n) {
    for (var i = n.toString().length, r = 0, u = "", f = "", t; i % 3 != 0;) i++, r++;
    if (r != 0)
        for (t = 0; t < r; t++) u += "0";
    for (u += n.toString(), t = 0; t < i; t++) f += u.charAt(t), t > 0 && (t + 1) % 3 == 0 && t != i - 1 && (f += ".");
    return f.substring(r)
}

function SetTotalMoneyCard() {
    var n = parseInt($("#content_1 label.check").attr("data-price")),
        t = parseInt($("#iQuantity").val());
    $("#content_1 .money").html("ThĂ nh tiá»n: <span>" + formatNumberValue(n * t) + "Ä‘<\/span>")
}
...
function ChangePrice(n) {
    var r, i, t;
    for ($("#warningprice").html(""), $("#warningphone").html(""), $("#content_1").find("label").each(function () {
            $(this).attr("class") == "check" && $(this).removeClass("check")
        }), $(n).attr("class", "check"), $("#iQuantity").val("1"), $("#txtEmail").hide(), $(".choosenum").html("1 tháº»"), r = parseInt($(n).attr("data-max")), i = "", t = 0; t < r; t++) i += '<a href="javascript:void(0)" data-value="' + (t + 1) + '">' + (t + 1) + " tháº»<\/a>";
    $(".numcard").html(i);
    $(".numcard a").click(function () {
        $(".numcard").slideToggle();
        $(this).attr("data-value") == "1" ? $("#txtEmail").hide() : $("#txtEmail").show();
        $(".choosenum").text($(this).attr("data-value") + " tháº»");
        $("#iQuantity").val($(this).attr("data-value"));
        SetTotalMoneyCard()
    });
    SetTotalMoneyCard()
}

function checkAllCaseCard() {
    var n = 0,
        t = "";
    if (ShowMsg("#warningprice", ""), n = parseInt($("#content_1 label.check").attr("data-value")), $.trim($("#txtPhone").val()) === "") {
        ShowMsg("#warningphone", "Vui lĂ²ng nháº­p sá»‘ Ä‘iá»‡n thoáº¡i");
        return
    }
    ShowMsg("#warningphone", "");
    t = $.trim($("#txtPhone").val());
    t.length >= 10 && n >= 5e4 && $.ajax({
        type: "POST",
        cache: !1,
        async: !1,
        url: "/aj/PaymentRechargeV3/CheckCard/",
        data: {
            strPhone: t,
            iPrice: n
        },
        ...
        success: function (n) {
            $("#dlding").fadeOut(500);
            n.n === 0 ? ShowMsg("#warningphone", n.msg) : ($("#btnCardATM").addClass("atm"), $("#btnCardVISA").addClass("visa"))
        },
        error: function () {
            $("#dlding").hide()
        }
...
function paymentWay(n, t) {
    $("#warningprice").html("");
    $("#warningphone").html("");
    var i = 0,
        r = "";
    if ($(n).hasClass("disable")) {
        if ($("#content_1 label.check").length != 1) {
            ShowMsg("#warningprice", "Vui lĂ²ng chá»n má»‡nh giĂ¡ tháº»");
            return
        }
        ShowMsg("#warningprice", "");
        return
    }(i = parseInt($("#content_1 label.check").attr("data-value")), r = $.trim($("#txtPhone").val()), f_a_i != !0) && $.ajax({
        async: !0,
        url: "/tien-ich/aj/Home/PaymentWayFooterV4/",
        data: {
            strPhone: r,
            iPrice: i,
            iType: t,
        ...
        success: function (n) {
            $("#dlding").fadeOut(500);
            n.rs === 1 ? (n.url !== null || n.url !== "") && (window.location = n.url) : (ShowMsg("#warningphone", n.msg), f_a_i = !1)
        },
        error: function () {
            f_a_i = !1;
            $("#dlding").hide()
...
function refresh() {
    $("#idWarningTraGop").html("");
    $("#idHopDongTraGop").html("");
    ischeck = !1
}
...
function paymentInstallment(n, t) {
    var i = 0,
        r = "",
        u = "";
    if (i = parseInt($("#ddlInstallment").val()), r = $("#txtHDCode").val(), u = $("#txtPayPrice").val(), i <= 0) {
        $("#idWarningTraGop").html("Vui lĂ²ng chá»n cĂ´ng ty cáº§n Ä‘Ă³ng tiá»n tráº£ gĂ³p.");
        return
    }
    if (r === "") {
        $("#idWarningTraGop").html("Vui lĂ²ng nháº­p mĂ£ há»£p Ä‘á»“ng cáº§n Ä‘Ă³ng tiá»n tráº£ gĂ³p.");
        return
    }
    if (i !== 1 && u === "") {
        $("#idWarningTraGop").html("Vui lĂ²ng nháº­p sá»‘ tiá»n cáº§n thanh toĂ¡n.");
        return
    }
    ispay || $.ajax({
        async: !0,
        url: "/aj/PaymentRechargeV3/PaymentInstallment/",
        data: {
            iCompany: i,
            strCodeNumber: r,
            strPrice: u,
        ...
        success: function (n) {
            ispay = !1;
            $("#dlding").fadeOut(500);
            n.rs === 1 ? n.url !== "" && (window.location = n.url) : $("#idWarningTraGop").html(n.msg)
        },
        error: function () {
            ispay = !1;
            $("#dlding").hide()
...
function qcp_createHtml(n) {
    var t, r, i;
    $("body .quickCpr").length == 0 && (t = "", r = "sáº£n pháº©m", n == 42 ? r = "Ä‘iá»‡n thoáº¡i" : n == 44 ? r = "laptop" : n == 522 && (r = "mĂ¡y tĂ­nh báº£ng"), t += '<div class="stickcompare">', t += '<div class="small">', t += "<ul>", t += '<li id="btnMinimize" onclick=qcp_changeMinimize();><i><\/i> Thu nhá»<\/li>', t += "<li><span>|<\/span><\/li>", t += "<li onclick='qcp_off();'>Táº¯t so sĂ¡nh<\/li>", t += "<\/ul>", t += "<\/div>", t += '<ul class="comlist">', t += '<li id="qPr1">', t += "<\/li>", t += '<li id="qPr2">', t += "<\/li>", t += '<li id="qPr3">', t += "<\/li>", t += "<li>", t += '<a href="javascript:void(0);" class="viewdisable viewfullcomp">So sĂ¡nh chi tiáº¿t<\/a>', t += '<span class="textmin">Tá»‘i thiá»ƒu 2 sáº£n pháº©m<\/span>', t += "<\/li>", t += "<\/ul>", t += "<\/div>", $("body").append(t), i = "", i += '<form action="javascript:void(0)">', i += '<input type="search" name="" placeholder="So sĂ¡nh vá»›i ' + r + ' gĂ¬..." onkeyup="qcp_SuggestCompare(this,event)" >', i += '<button type="submit"><i class="icontgdd-scomp"><\/i><\/button>', i += "<\/form>", $("#qPr1").html(i), $("#qPr2").html(i), $("#qPr3").html(i))
}

function qcp_checkAdd(n, t) {
    var i = !0;
    return $(".comlist li").each(function () {
        n == $(this).attr("data-id") && (i = !1, alert('Báº¡n Ä‘Ă£ thĂªm sáº£n pháº©m "' + t + '" vĂ o so sĂ¡nh'))
    }), i
}

function qcp_addProdQcp(n, t, i, r) {
    if (r != !0 && (r = !1), !(parseInt(n) > 0)) return !1;
    if (g_qcp_prod1 != "" && g_qcp_prod2 != "" && g_qcp_prod3 != "") return alert("Báº¡n Ä‘Ă£ chá»n 3 sáº£n pháº©m Ä‘á»ƒ so sĂ¡nh"), $(".stickcompare").show(), qcp_maximize(), !1;
...
function qcp_clearAll() {
    ...
    n += '<input type="search" name="" placeholder="So sĂ¡nh vá»›i sáº£n pháº©m gĂ¬..." onkeyup="qcp_SuggestCompare(this,event)" >';
...
function qcp_changeMinimize() {
    if (!g_qcp_mini) {
        ...
        $("#btnMinimize").html("<i class='v2'><\/i> Má»Ÿ rá»™ng");
        $(".stickcompare").css("height", "0");
        return
    }
    g_qcp_mini = !1;
    $(".stickcompare .comlist").show();
    $("#btnMinimize").html("<i><\/i> Thu nhá»");
...
var lastSuggest, timmer, gl_fLoadChat, f_a_i, ischeck, ispay, qcp_currID;
(function (n, t) {
    function gt(n) {
        var t = n.length,
            r = i.type(n);
    ...
    n.fn.lazyload = function (f) {
        ...
        var o = this,
            h, e = {
                ...
                appear: null,
                load: null,
                placeholder: "https://cdn.tgdd.vn/v2015/Content/images/lazyplaceholder.png"
            };
...
f_a_i = !1;
ischeck = !1;
$("#txtHDCode").on("keyup", refresh);
$("#btnHDATM").click(function () {
    var n = parseInt($(this).data("value"));
    paymentInstallment(this, n)
});
$("#btnHDVISA").click(function () {
    var n = parseInt($(this).data("value"));
    paymentInstallment(this, n)
});
